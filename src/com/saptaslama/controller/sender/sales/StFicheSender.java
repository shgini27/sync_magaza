...
public class StFicheSender extends Sender{
    ...
    public JsonObject getStFicheJson(ArrayList<StFiche> list) {
        ...
        for (int a = 0; a < list.size(); a++) {
            ...
            if((c.MAGAZA_CODE - list.get(a).getLogicalRef()) != 499999999){
                docTrackingGnr.add(a, String.valueOf(c.MAGAZA_CODE - list.get(a).getLogicalRef()));
            }else{
                JOptionPane.showMessageDialog(null, "DOCTRACKINGNR icin logRef 499999999 sayisini asmistir!");
            }
    ...
    public JsonObject getStLineJson(ArrayList<StLine> list) {
        ...
        for (int a = 0; a < list.size(); a++) {
            ...
            //here we setting the specode with local logicalRef (example: if depo then we adding "D" infront of LogREf)
            if((c.MAGAZA_CODE - list.get(a).getLogicalRef()) != 499999999){
                outputIdCode.add(a, String.valueOf(c.MAGAZA_CODE - list.get(a).getLogicalRef()));
            }else{
